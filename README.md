...
.- On a 5 fichiers: cartes, data, graphics, ile, joueur qui contiennent respectivement les cartes des joueurs, les images pour les illustrations grpahiques et les affichages, ile qui contient les modèles pour l'île et joueur qui contient le modèle des joueurs. Le main du jeu est dans Jeu.java .
